...
namespace Parking.Api.Data.Migrations
{
    ...
    [Migration("20260310204404_AddVeiculoHistorico")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parking.Api.Models.VeiculoClienteHistorico", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("VeiculoId", "DataInicio", "DataFim")
                        .HasDatabaseName("idx_veiculo_cliente_historico_lookup");

                    b.ToTable("veiculo_cliente_historico", "public");
                });
            ...
            modelBuilder.Entity("Parking.Api.Models.VeiculoClienteHistorico", b =>
                {
                    b.HasOne("Parking.Api.Models.Cliente", null)
                        .WithMany()
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Parking.Api.Models.Veiculo", null)
                        .WithMany()
