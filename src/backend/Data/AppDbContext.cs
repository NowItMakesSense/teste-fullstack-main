...
namespace Parking.Api.Data
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<VeiculoClienteHistorico> HistoricoVeiculos => Set<VeiculoClienteHistorico>();
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VeiculoClienteHistorico>(entity =>
            {
                entity.ToTable("veiculo_cliente_historico", "public");
                ...
                entity.HasIndex(e => new { e.VeiculoId, e.DataInicio, e.DataFim }).HasDatabaseName("idx_veiculo_cliente_historico_lookup");
